                    ...
                    @forelse ($pedidos as $pedido)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <i class="fas fa-utensils"></i> Levantar pedido
                                </a>
                                <a href="{{ route('pedidos.show', $pedido) }}" class="btn btn-sm btn-outline-primary">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('pedidos.edit', $pedido) }}" class="btn btn-sm btn-outline-warning">
                               ...
                               @if($pedido->estado === 'listo_para_cobrar')
                                ...
                                <form action="{{ route('pedidos.destroy', $pedido) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                                    <button class="btn btn-sm btn-outline-danger" onclick="return confirm('¿Eliminar este pedido?')">
